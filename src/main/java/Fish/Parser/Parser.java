...
public class Parser {
    ...
    /**
     * Returns the command portion of the input sentence. Ignores additional
    ...
    /**
     * Returns the argument portion of the input sentence. Ignores additional
    ...
    /**
     * Returns a Command object that corresponds
